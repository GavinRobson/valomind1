  ...
  return (
    <button
      ...
      className={cn(
        ...
        !isLoading &&
          !updated &&
          'hover:text-[#FB5454] hover:outline-[#FB5454] hover:outline-1 hover:bg-neutral-700'
      )}
    >
      <div
        className={cn(
          ...
          !isLoading &&
            !updated &&
            'group-hover:w-[30px] group-hover:bg-[#FB5454]'
        )}
      />
      {isLoading ? (
        <div className="opacity-80 fixed">Updating...</div>
      ) : updated ? (
        <div className="opacity-80 fixed">Updated!</div>
      ) : (
